...
export const en = {
  ...
  dialogs: {
    ...
    backup: {
      ...
      hint: "Create a full schema + data SQL backup of",
      fileNameLabel: "File name",
      locationLabel: "Destination folder",
      chooseFolderHint: "No folder selected",
      browse: "Browse…",
      download: "Download",
      downloading: "Backing up {{table}}…",
  ...
  toast: {
    ...
    runBeforeDownload: "Run a query before downloading results",
    downloadSaved: "Results saved",
  ...
  shortcuts: {
    ...
    nextPage: "Next results page",
    prevPage: "Previous results page",
