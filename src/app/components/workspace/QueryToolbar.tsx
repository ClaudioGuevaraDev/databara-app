    ...
    <div className="chrome-panel hairline flex h-10 shrink-0 items-center border-b border-border px-2">
      <div className="flex items-center gap-1">
        <button
          onClick={onRun}
          disabled={isRunning}
          className="flex h-7 shrink-0 items-center gap-1.5 whitespace-nowrap rounded bg-primary px-2.5 text-[12px] font-semibold text-primary-foreground shadow-[0_0_20px_hsl(var(--primary)/0.14)] hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70"
        >
          {isRunning ? (
        ...
        <button
          ...
          className={cn(
            "ml-1 flex h-7 shrink-0 items-center gap-1.5 whitespace-nowrap rounded px-3 text-[12px] font-semibold transition disabled:cursor-not-allowed disabled:opacity-45",
            canSave
